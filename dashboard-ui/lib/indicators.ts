...
const CARD_METRIC_MAP: Record<string, CardMetricConfig> = {
  ...
  "/ai-performance":     { key: "meaningful_engagement_rate", format: (v) => `${pct(v as number | null)} engagement`,  colorType: "positive" },
  "/conversion-funnel":  { key: "booking_rate",               format: (v) => `${pct(v as number | null)} booking`,     colorType: "positive" },
